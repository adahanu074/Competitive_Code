...
ACCESS_DATA="grant_type=urn%3Aietf%3Aparams%3Aoauth%3Agrant-type%3Asaml2-bearer&assertion=$BEARER_TOKEN&scope=spark-admin%3Ahybrid_clusters_read%20spark-admin%3Ahybrid_connectors_read";
